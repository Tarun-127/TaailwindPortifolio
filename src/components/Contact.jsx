            ...
            <div class="flex justify-center">
                <div class="grid md:grid-cols-2">
                        ...
                        <ul>
                            <li class="flex">
                                ...
                                <div class="m-5">
                                    ...
                                    <p class="text-gray-400">Flat No:- G01, Sakthi Residency , Sheelnagar</p>
                                    <p class="text-gray-400">Visakhapatnam</p>
                                    <p class="text-gray-400">Pincode:- 530012</p>
                                </div>
                            </li>
                            <li class="flex">
                                ...
                                <div class="m-5">
                                    ...
                                    <p class="text-gray-400">Mobile: 8520951354</p>
                                    <p class="text-gray-400">Mail: ktharun127@gmail.com</p>
                                </div>
                            </li>
                            <li class="flex">
                    ...
                    <div class="max-w-6xl p-5 md:p-12" id="form">
                        ...
                        <form action="https://getform.io/f/ebpwdgpa" method="POST">
                            <div class="mb-6">
