...
const Navbar = () => {
  ...
  return (
    <div className='px-4 sm:px-6 lg:px-8 mx-auto max-w-[1500px] h-[8vh]'>
      <div className='flex item-center justify-between h-16 lg:h-20 bg-[#223]/30 rounded-b-3xl shadow-lg px-4'>
         
        <div className="text-white text-xl sm:text-2xl">
          <a href="#" className='font-bold'><span>Tarun Kumar Ravva</span></a>
        </div>
      
          <ul className='text-grey-700 font-medium hidden lg:flex lg:items-center lg:justify-center lg:space-x-10 text-2xl'>
       ...
       <div onClick={handleNav} className='block md:hidden text-white z-40'>
        ...
        <div className= {nav ? 'z-30 text-grey-300 fixed h-[50%] left-0 top-0 w-full bg-[#202121] ease-in-out duration-500'
        :'fixed left-[-100%]'}>
